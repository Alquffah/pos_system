...
class App(tk.Tk):
    ...
    def add_tab(self):
        tab1 = items_database(self.notebook)
        tab2 = cashier(self.notebook)
        tab3 = history(self.notebook)
        tab4 = settings(self.notebook)
        self.notebook.add(tab1,text="Database")
        self.notebook.add(tab2,text="Cashier")
...
class items_database(ttk.Frame):
    def __init__(self,name,*args,**kwargs):
        ...
        self.data_tree = self.create_data_tree()
        self.show_database()
    ...
    #Scrollbars
        ...
        self.data_tree.configure(xscrollcommand = verscrlbar.set)
    ...
    def create_data_tree(self):
        ...
        self.data_tree["columns"] = ("name", "Sale", "Cost", "Profit", "Quantity", "Barcode", "id")
    ...
    def show_database(self):
        ...
        items_list = database.table().records()
...
class cashier(ttk.Frame):
    def __init__(self,name,*args,**kwargs):
        ttk.Frame.__init__(self,*args,**kwargs)
        self.label = ttk.Label(self, text="Hi This is Tab2")
